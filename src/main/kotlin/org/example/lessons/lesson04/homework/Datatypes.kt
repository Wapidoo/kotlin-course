package org.example.org.example.lessons.lesson04.homework
...
// val v6: Boolean = FALSE должно быть написано false
val v7: Char = 'c'
val v8: Short = 500
...
// val v30 = FALSE - должно быть в нижнем регистре
val v31: Double = 0.007
// val v32 = “🤯” - должны быть одинарные кавычки
val v33: Map<String, Int> = mapOf("true" to 2, "false" to 34)
// val v34 = ‘65535’ - число в одинарных кавычках
...
// val v44 = TRUE - должно быть в нижнем регистре
...
//Хранить массу воздуха в спускающем матрасе после нападения кота в долях грамма - Double \ Float
//Хранить словарь «название стартапа → сумму потерь инвесторов» - String
//Хранить строку «починилось само», чтобы закрывать тикеты без лишних слов - String
//Хранить список тем для митингов, которые на самом деле никому не нужны - listOf